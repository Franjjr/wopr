...
from api.models import db, Users, Centers, Compositions, Recipes, Suppliers, References, Previsions, DeliveryNotes, DeliveryNoteLines, CompositionLines, LineRecipes, ManufacturingOrders, ProductsFormats
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(ProductsFormats, db.session))
